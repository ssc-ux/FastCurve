<script lang="ts">
  ...
  import { todayISO, formatDate } from '../../lib/models/types';
...
<div class="col" style="gap:14px;">
  ...
  <div class="card" style="padding:12px;">
    <div class="row wrap">
      ...
      <input type="date" bind:value={annDate} />
    ...
    <div class="col" style="gap:6px;">
      {#each annotations as a (a.id)}
        <div class="card mini">
          ...
          <input type="date" value={a.date} oninput={(e) => store.updateAnnotation(a.id, { date: e.currentTarget.value })} />
